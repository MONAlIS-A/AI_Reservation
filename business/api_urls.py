...
urlpatterns = [
    ...
    path("create/", CreateBusinessAPIView.as_view(), name="api_create_business"),
    path("global-chat/", GlobalChatAPIView.as_view(), name="api_global_chat_api"),
    ...
    path("chat/<str:business_name>/", BusinessDetailByNameAPIView.as_view(), name="api_chatbot_data"),
